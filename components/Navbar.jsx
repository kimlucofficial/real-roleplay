...
const isRulesActive = page === 'rules-oc';
  const goTo = (key) => {
    setPage(key);
    setMobileOpen(false);
        ...
        <div className={`mobile-nav ${mobileOpen ? 'show' : ''}`}>
          ...
          {mobileRulesOpen && (
            <div className="mobile-submenu">
              ...
              <button className={page === 'rules-oc' ? 'active' : ''} onClick={() => goTo('rules-oc')}>OOC</button>
            </div>
          )} */}
              <button className={page === 'rules-oc' ? 'active' : ''} onClick={() => goTo('rules-oc')}>LUẬT CHUNG</button>
