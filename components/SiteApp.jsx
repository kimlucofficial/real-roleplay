...
function Hero({ setPage, discordUrl }) {
  ...
  const rules = [
    ['NHÂN VẬT TRƯỚC TIÊN', 'Nhân vật của bạn phải có lý lịch rõ ràng, mục tiêu và định hướng phát triển hợp lý.', Users],
    ['NHẬP VAI NGHIÊM TÚC', 'Chúng tôi tìm kiếm những người chơi thật sự muốn sống trong thế giới này — không phá hoại, không troll.', ScrollText],
    ['XEM XÉT BỞI ADMIN', 'Hồ sơ của bạn sẽ được đội ngũ quản trị xem xét kỹ lưỡng. Quyết định của Admin là quyết định cuối cùng.', Shield]
  ];
  const bottom = [
      ...
      <div className="container rr-home-inner">
        ...
        <div className="rr-home-right">
          <div className="rr-access-panel">
            <div className="rr-section-label">TIÊU CHUẨN TRUY CẬP</div>
            <h2>TRUY CẬP XÁC ĐỊNH<br/>CHẤT LƯỢNG THÀNH PHỐ</h2>
            ...
            <div className="rr-next-box"><div><div className="rr-section-label">HÀNH ĐỘNG TIẾP THEO</div><h3>GỬI YÊU CẦU TRUY CẬP</h3><p>Mỗi đơn đăng ký sẽ được xem xét thủ công. Hãy thể hiện bạn là người xứng đáng bước vào thành phố.</p></div></div>
          </div>
        </div>
    ...
    <section className="rr-intro-locked">
      ...
      <div className="container rr-intro-grid">
        <div className="rr-intro-left">
          ...
          <div className="rr-home-actions rr-intro-actions"><button className="rr-solid-btn">REQUEST ACCESS <ArrowRight size={18}/></button><button className="rr-outline-btn">EARLY JOURNEY</button></div>
      ...
      <div className="container rr-rules-hero-grid">
        <div className="rr-rules-copy">
          ...
          <div className="rr-rules-actions">
            <button className="rr-rules-primary" onClick={() => setPage?.('whitelist')}>REQUEST ACCESS <ArrowRight size={18} /></button>
