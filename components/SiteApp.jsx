...
function WhitelistPage({ setPage }) {
  ...
  const [form, setForm] = useState({ full_name: '', age: '', rp_experience: '', online_time: '', source: 'Kiểm Soát Chất Lượng', short_description: '', backstory: '', why_join: '' });
  ...
  const wordLimitedFields = new Set(['backstory', 'why_join']);
  ...
  const submit = async (e) => {
    ...
    try {
      ...
      setForm({ full_name: '', age: '', rp_experience: '', online_time: '', source: 'Kiểm Soát Chất Lượng', short_description: '', backstory: '', why_join: '' });
    } catch (err) {
