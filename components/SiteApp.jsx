    ...
    <section className="hero">
      ...
      <div className="container hero-grid">
        <div className="hero-copy">
          ...
          <div className="stats">
            {[['Chaos', 'Undergound'], ['Laws', 'Polices on the way'], ['Angels', 'Medicines from Medics']].map(([v, l]) => (
  ...
  return (
    <>
      ...
      <section className="rrx-banner-section">
        ...
        <div className="container rrx-banner-content">
          <div className="rrx-small-label">
            {/* Los Santos NIGHTS */}
          </div>

          <h2>
            {/* Một thành phố nơi mọi quyền lực
            đều phải trả giá. */}
          </h2>
        </div>
      </section>
  ...
  return (
    <>
      <section className="rrx-hero">
        ...
        <div className="rrx-video-overlay" />
        <div className="rrx-noise" />
        <div className="rrx-grid-bg" />
        <div className="rrx-orb rrx-orb-gold" />
        <div className="rrx-orb rrx-orb-blue" />
        <div className="rrx-orb rrx-orb-red" />

        <div className="container rrx-hero-inner">
          <div className="rrx-left">
            <div className="rrx-chip">
              REAL ROLEPLAY • Los Santos • HARD ROLEPLAY
            </div>

            <h1 className="rrx-title">
              REAL
              <span>ROLEPLAY</span>
            </h1>

            <p className="rrx-lead">
              Một thành phố lấy cảm hứng từ Los Santos nơi quyền lực,
              tiền bạc, băng đảng và pháp luật cùng tồn tại trong một
              hệ sinh thái roleplay khắc nghiệt.
            </p>

            <div className="rrx-actions">
              <button className="rrx-primary">
                REQUEST ACCESS
                <ArrowRight size={18} />
              </button>

              <button className="rrx-secondary">
                CITY PHILOSOPHY
              </button>
            </div>

            <div className="rrx-stats">
              <div>
                <strong>WL</strong>
              ...
              <div>
                <strong>HRP</strong>
                <span>Hard Roleplay</span>
              </div>

              <div>
                <strong>LA</strong>
                <span>Los Santos Inspired</span>
              </div>
            </div>
          </div>

          <div className="rrx-right">
            <div className="rrx-city-card">
              <div className="rrx-card-head">
                <span>City Structure</span>
                <h2>Power Balance</h2>
              </div>

              <div className="rrx-role-stack">
                <div className="rrx-role police">
                  <h3>Police Department</h3>
                  <p>
                    Điều tra, tactical operations, truy quét và áp lực pháp luật
                    thật sự lên toàn bộ thế giới ngầm.
                  </p>
                </div>

                <div className="rrx-role ems">
                  <h3>Emergency Medical Services</h3>
                  <p>
                    EMS giữ nhịp sinh tồn của thành phố với các tuyến cứu hộ,
                    tai nạn và medical roleplay có chiều sâu.
                  </p>
                </div>

                <div className="rrx-role gang">
                  <h3>Underworld & Gangs</h3>
                  <p>
                    Territory, money, influence và những cuộc chiến kéo dài
                    được xây bằng nhiều tháng roleplay thực tế.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="rrx-marquee">
          HARD ROLEPLAY • POLICE • EMS • GANGS • Los Santos • REAL ROLEPLAY •
        </div>
      </section>
    </>
  );
  ...
  return (
    <>
      <PageHero
        ...
        rightTitle={isOoc ? 'Overall' : 'In Characters'}
      rightItems={[
  [
    isOoc ? 'Quy chuẩn cộng đồng' : 'Quy chuẩn nhập vai',
    isOoc
      ? 'Toàn bộ quy định về cách giao tiếp, hành xử và giữ môi trường cộng đồng văn minh.'
      : 'Các quy định giúp giữ logic, chiều sâu và tính chân thực cho toàn bộ roleplay.'
  ],

  [
    isOoc ? 'Xử lý nghiêm' : 'Tôn trọng cốt truyện',
    isOoc
      ? 'Các hành vi toxic, metagaming, exploit hoặc phá trải nghiệm sẽ bị xử lý nghiêm khắc.'
      : 'Mọi hành động cần phù hợp với câu chuyện, hoàn cảnh và nhận thức của nhân vật.'
  ],

  [
    isOoc ? 'Định hướng cộng đồng' : 'Triết lý thành phố',
    isOoc
      ? 'Real Roleplay ưu tiên sự trưởng thành, tôn trọng và chất lượng người chơi.'
      : 'Một thành phố nơi mọi lựa chọn đều để lại hậu quả và mọi danh tiếng đều phải tự xây dựng.'
  ]
]}
        rightNote={isOoc
          ? 'Đây là nhóm luật chung và tiêu chuẩn cộng đồng.'
          : 'IC = In Character. Đây là nhóm luật hành xử bên trong thế giới roleplay.'}
        accent={isOoc ? 'red' : 'gold'}
      />
  ...
  return (
    <>
      <PageHero
        eyebrow="UPDATE 1.0"
        title="UPDATE 1.0"
        description="Bắt đầu từ con số không. Không tài sản, không danh tiếng, không mối quan hệ. Mỗi quyết định đầu tiên sẽ định hình cách bạn tồn tại trong thành phố."
        rightTitle="SỰ KHỞI ĐẦU"
        rightItems={[
          ['FIRST STEPS', 'Làm quen với cuộc sống mới thông qua các công việc cơ bản, gặp gỡ những người xung quanh và xây dựng câu chuyện của riêng bạn.'],
          ['CAREER PATH', 'Từ những công việc nhỏ như câu cá, khai thác tài nguyên hay vận chuyển hàng hóa, mọi lựa chọn đều có thể trở thành bước khởi đầu cho một hướng đi lớn hơn.'],
          ['SOCIAL CONNECTION', 'Thành phố không được xây bằng hệ thống, mà được xây bằng con người. Các mối quan hệ sẽ mở ra cơ hội, xung đột và những câu chuyện không thể đoán trước.']
        ]}
        rightNote="BUILD YOUR STORY — Đừng vội vàng tìm kiếm đích đến. Trong REAL ROLEPLAY, hành trình quan trọng hơn điểm kết thúc."
        accent="red"
      />
